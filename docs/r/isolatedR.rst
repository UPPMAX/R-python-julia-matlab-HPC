...
.. note::
   ...
   To access the packages installed in the renv, you either need to activate it or be in that directory. Load the R module and prerequisistes (and possibly R_packages on UPPMAX and R-bundle-Bioconductor on HPC2N) and do: 
